...
public class AppDesktop {
    public static void main(String[] args) {
        // Khởi tạo SDK bảo vệ với ID sản phẩm là 04
        TalltLicenseGuard guard = new TalltLicenseGuard("4");
        ...
        guard.requireLicenseToLaunch(() -> {
            ...
            javax.swing.JFrame frame = new javax.swing.JFrame("Main Vendor App 4");
            ...
            javax.swing.JLabel label = new javax.swing.JLabel("Phần mềm chính 4 đang hoạt động...",
