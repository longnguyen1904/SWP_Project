...
CREATE TABLE `Refunds` (
  ...
  KEY `OrderID` (`OrderID`),
  CONSTRAINT `Refunds_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `Orders` (`OrderID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `WalletTransactions` (
  ...
  `Type` enum('DEPOSIT','WITHDRAWAL','SALE_REVENUE','REFUND','COMMISSION_FEE') COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-01-21 14:34:10
