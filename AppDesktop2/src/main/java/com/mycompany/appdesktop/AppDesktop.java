...
public class AppDesktop {
    public static void main(String[] args) {
        // Khởi tạo SDK bảo vệ với ID sản phẩm là 02
        TalltLicenseGuard guard = new TalltLicenseGuard("2");
        ...
        guard.requireLicenseToLaunch(() -> {
            ...
            javax.swing.JFrame frame = new javax.swing.JFrame("Main Vendor App 2");
            ...
            javax.swing.JLabel label = new javax.swing.JLabel("Phần mềm chính 2 đang hoạt động...",
